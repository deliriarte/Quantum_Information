program test_performance
    ...
    open(12, file = 'input_data.dat', status = 'old', action = 'readwrite')
    read(12, *) n
    
    !For simplicy consider square matrix with equal dimension for both matrices. 
    m = n
    l = n
    ...
    write(*,*) time_matmul
    write(*,*) time_matxmat_1
    write(*,*) time_matxmat_2 
